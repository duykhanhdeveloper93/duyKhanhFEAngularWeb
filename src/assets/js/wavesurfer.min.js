    ...
    class h extends e {
        ...
        initDrag() {
            this.subscriptions.push(
                (function (t, e, i, n, s = 3, r = 0, o = 100) {
                    if (!t) return () => {};
            ...
            return t(this, void 0, void 0, function* () {
                ...
                if (i.barWidth || i.barGap) {
                    const t = i.barWidth || 0.5,
                        e = t + (i.barGap || t / 2);
                    d % e != 0 && (d = Math.floor(d / e) * e);
                }
                const c = (t) => {
                        const n = t * d,
                            a = Math.min(l - n, d),
                            h = e.map((t) => {
                                const e = Math.floor((n / l) * t.length),
                                    i = Math.floor(((n + a) / l) * t.length);
                                return t.slice(e, i);
                            });
                        this.renderSingleCanvas(h, i, a, s, n, r, o);
                    },
                    u = Math.ceil(l / d);
                if (1 === u) return void c(0);
                ...
                c(m),
                    ...
                    yield Promise.all([
                        ...
                        (() =>
                            t(this, void 0, void 0, function* () {
                                const t = this.createDelay();
                                for (let e = m + 2; e < u; e++) yield t(), c(e);
                            }))(),
                    ]);
            });
        }
            ...
            return t(this, void 0, void 0, function* () {
                ...
                try {
                    if (this.options.splitChannels)
                        yield Promise.all(
                            Array.from({ length: e.numberOfChannels }).map(
                                (t, i) => {
                                    var n;
                                    const s = Object.assign(
                                        Object.assign({}, this.options),
                                        null ===
                                            (n = this.options.splitChannels) ||
                                            void 0 === n
                                            ? void 0
                                            : n[i]
                                    );
                        ...
                        e.numberOfChannels > 1 && t.push(e.getChannelData(1)),
                            yield this.renderChannel(t, this.options, r, 0);
                    }
                } catch (t) {
                    return;
                }
    ...
    class u extends a {
        ...
        constructor(t) {
            ...
            Promise.resolve().then(() => {
                ...
                (n || (t && e)) && this.load(n, t, e).catch(() => null);
            });
        }
        ...
        loadAudio(e, n, s, r) {
            return t(this, void 0, void 0, function* () {
                ...
                if (s) this.decodedData = i.createBuffer(s, a || 0);
                    ...
                    this.decodedData = yield i.decode(
                        t,
