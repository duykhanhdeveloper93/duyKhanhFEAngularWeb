                            ...
                            switch (n.browser) {
                                case "chrome":
                                    ...
                                    r("adapter.js shimming chrome."),
                                        ...
                                        u.shimParameterlessSetLocalDescription(
                                            e,
                                            n
                                        ),
                                        ...
                                        u.shimRTCIceCandidateRelayProtocol(
                                            e,
                                            n
                                        ),
                    ...
                    Object.defineProperty(r, "__esModule", { value: !0 }),
                        ...
                        (r.shimAddTrackRemoveTrack = function (i, e) {
                            if (i.RTCPeerConnection) {
                                if (
                                    i.RTCPeerConnection.prototype.addTrack &&
                                    65 <= e.version
                                )
                                    return p(i);
                                var r =
                                ...
                                Object.defineProperty(
                                    ...
                                    (i.RTCPeerConnection.prototype.removeTrack =
                                        function (t) {
                                            var r,
                                                n = this;
                                            if (
                                    ...
                                    function (e) {
                                        return (
                                            (this._shimmedLocalStreams =
                                                this._shimmedLocalStreams ||
                                                {}),
                                            delete this._shimmedLocalStreams[
                                                e.id
                                            ],
                                            t.apply(this, arguments)
                                        );
                            ...
                            return (
                                ...
                                r &&
                                    Object.keys(
                                        ...
                                        var t =
                                            n._shimmedLocalStreams[e].indexOf(
                                                r
                                            );
                                        -1 !== t &&
                                            n._shimmedLocalStreams[e].splice(
                                                t,
                                                1
                                            ),
                                            1 ===
                                                n._shimmedLocalStreams[e]
                                                    .length &&
                                                delete n._shimmedLocalStreams[
                                                    e
                                                ];
                                    }),
                                o.apply(this, arguments)
                            ...
                            (o.navigator.mediaDevices &&
                                ...
                                (o.navigator.mediaDevices &&
                                    ("function" != typeof e
                                        ...
                                        : (o.navigator.mediaDevices.getDisplayMedia =
                                              function (i) {
                                                  return e(i).then(function (
                                                      ...
                                                      return (
                                                          ...
                                                          t &&
                                                              (i.video.mandatory.maxWidth =
                                                                  t),
                                                          r &&
                                                              (i.video.mandatory.maxHeight =
                                                                  r),
                        ...
                        (r.shimGetUserMedia = function (e, t) {
                            ...
                            s.mediaDevices &&
                                ...
                                s.mediaDevices.getUserMedia &&
                                    ((r = s.mediaDevices.getUserMedia.bind(
                                        s.mediaDevices
                                    )),
                                    (s.mediaDevices.getUserMedia = function (
                                        e
                                    ) {
            ...
            6: [
                function (e, t, r) {
                    ...
                    Object.defineProperty(r, "__esModule", { value: !0 }),
                        ...
                        (r.shimParameterlessSetLocalDescription = function (
                            e,
                            t
                        ) {
                            var r;
                        ...
                        (r.shimGetDisplayMedia = function (t, r) {
                            (t.navigator.mediaDevices &&
                                "getDisplayMedia" in
                                    t.navigator.mediaDevices) ||
                                (t.navigator.mediaDevices &&
                                    (t.navigator.mediaDevices.getDisplayMedia =
                                        function (e) {
                                            return e && e.video
                                                ? (!0 === e.video
                                                      ? (e.video = {
                                ...
                                e = e && e.MediaStreamTrack;
                            {
                                ...
                                (n.getUserMedia = function (e, t, r) {
                                    ...
                                    (55 < t.version &&
                                        ...
                                        (i = n.mediaDevices.getUserMedia.bind(
                                            n.mediaDevices
                                        )),
                                            ...
                                            return (
                                                n &&
                                                    n.forEach(function (e) {
                                                        t._localStreams
                                                            ? t._localStreams.includes(
                                                                  e
                                                              ) ||
                                                              t._localStreams.push(
                                                                  e
                                                              )
                                                            : (t._localStreams =
                                                                  [e]);
                                                                ...
                                                                e.streams.forEach(
                                                                    function (
                                                                        ...
                                                                        r._remoteStreams ||
                                                                            (r._remoteStreams =
                                                                                []),
                                                                            r._remoteStreams.includes(
                                                                                e
                                                                            ) ||
                                                                                (r._remoteStreams.push(
                                                                                    e
                                                                                ),
                                                                                ((t =
                                                                                    new Event(
                            ...
                            e.RTCPeerConnection &&
                                ...
                                (e.removeEventListener = function (e, t) {
                                    ...
                                    return (
                                        ...
                                        0 === this._eventMap[n].size &&
                                            delete this._eventMap[n],
                                        0 ===
                                            Object.keys(this._eventMap)
                                                .length &&
                        ...
                        (p.writeFmtp = function (t) {
                            ...
                            return (
                                ...
                                t.parameters &&
                                    ...
                                    ((r = []),
                                    Object.keys(t.parameters).forEach(function (
                                        e
                                    ) {
